...
export default function Aboute() {
	...
	return (
		<>
			<main className="px-4 flex flex-col w-full h-fit text-xs md:text-sm xl:text-lg font-light text-T100 gap-5">
				...
				<div className="flex w-fit h-fit gap-4">
					<div className="border border-P100 w-full h-52 md:w-1/3 md:h-[530px] lg:h-[570px]"></div>
					<div className="flex flex-col gap-5 w-full md:w-2/3">
						...
						<p>With {yearsOfExperience} of experience in frontend web development, I've delved into challenging projects that have allowed me to enhance my skills in JavaScript/Typescript. I've collaborated in agile teams, participating from conception to the implementation of innovative solutions.</p>
						<p>Embarking on a relentless journey of self-improvement, I've cultivated my skills through distinguished educational ventures. I proudly hold certifications in Frontend Development from Alura, renowned as the premier software development school in Brazil. The accolades don't stop there—I've further honed my expertise with a Frontend Web certification from DevemDobro, an exclusive institution devoted solely to frontend mastery, complete with mentorship and guidance from seasoned developers. <br /><br /> These immersive experiences have fortified my foundation in Frontend Development, amplifying my proficiency in Javascript/Typescript. But it doesn't end there; I've delved into a spectrum of libraries and frameworks, mastering the artistry of ReactJS, ReactNative, Angular, NodeJS, NestJS, and NextJS.<br /></p>
				...
				<div className="border-P100 border w-full h-48 xl:h-80"></div>
				<p>Currently, I am based in MG/Brasil, ready for collaborations and innovative projects.</p>
				<p>Let's connect? I'm available for opportunities, partnerships, or just to exchange ideas. Feel free to find me on social media or send an email to <a href="mailto:bernardesmikael@outlook.com" className="text-P100 cursor-pointer hover:decoration-slice hover:underline transition-all duration-700 hover:decoration-P100">bernardesmikael@outlook.com</a>. <br /><br />I hope this visual and textual representation captures the essence of who I am as a frontend web developer. Feel free to explore more or get in touch. I'm looking forward to connecting with you!</p>
			</main>
		</>
	);
}